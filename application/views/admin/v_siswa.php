...
<head>
  ...
  <title>SMA Muh 5 Gatak | Data Siswa</title>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnis" class="form-control" id="inputUserName" 
                                            placeholder="NIS" autocomplete="off" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Diterima di Universitas</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xuniv" class="form-control" id="inputUserName" 
                                            placeholder="Nama Universitas" autocomplete="off" required>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnis" value="<?php echo $nis;?>" class="form-control" 
                                            id="inputUserName" autocomplete="off" placeholder="NIP" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            id="inputUserName" autocomplete="off" placeholder="Nama" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                          <input type="text" name="xuniv" value="<?php echo $univ_id;?>" class="form-control" 
                                          id="inputUserName" autocomplete="off" placeholder="Nama Universitas" required>
                                        </div>
                                    </div>
