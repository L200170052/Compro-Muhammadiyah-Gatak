...
<head>
  ...
  <title>SMA Muh 5 Gatak | Data Pengumuman</title>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                  <input type="text" name="xjudul" class="form-control" autocomplete="off" id="inputUserName" placeholder="Judul" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Deskripsi</label>
                                <div class="col-sm-7">
                                  <textarea class="form-control" rows="3" name="xdeskripsi" autocomplete="off" placeholder="Deskripsi ..." required></textarea>
                                </div>
                            </div>
