...
<head>
  ...
  <title>SMA Muh 5 Gatak | Kategori Berita</title>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xkategori" class="form-control" autocomplete="off" id="inputUserName" placeholder="Kategori" required>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <input type="text" name="xkategori" class="form-control" id="inputUserName" value="<?php echo $kategori_nama;?>" autocomplete="off" placeholder="Kategori" required>
                                        </div>
                                    </div>
