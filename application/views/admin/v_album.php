...
<head>
  ...
  <title>SMA Muh 5 Gatak | Album Photo</title>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnama_album" class="form-control" id="inputUserName" autocomplete="off" placeholder="Nama Album" required>
                                        </div>
                                    </div>
