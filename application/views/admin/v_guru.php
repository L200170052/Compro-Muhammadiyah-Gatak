...
<head>
  ...
  <title>SMA Muh 5 Gatak | Data Guru</title>
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <div class="pull-right">
      <a href="" class="go-top">
        <i class="fa fa-chevron-circle-up" style="font-size:18px"></i>
      </a>
    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnip" class="form-control" 
                                            autocomplete="off" id="inputUserName" placeholder="NIP" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnama" autocomplete="off" class="form-control" id="inputUserName" placeholder="Nama" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xtmp_lahir" autocomplete="off" class="form-control" id="inputUserName" placeholder="Tempat Lahir" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xtgl_lahir" autocomplete="off" class="form-control" id="inputUserName" placeholder="Contoh: 25 September 1993" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xmapel" autocomplete="off" class="form-control" id="inputUserName" placeholder="Contoh: PPKN, Matematika" required>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">NIP</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnip" value="<?php echo $nip;?>" class="form-control" id="inputUserName" autocomplete="off" placeholder="NIP" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nama</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnama" value="<?php echo $nama;?>" class="form-control" id="inputUserName" autocomplete="off" placeholder="Nama" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tempat Lahir</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xtmp_lahir" value="<?php echo $tmp_lahir;?>" class="form-control" id="inputUserName" autocomplete="off" placeholder="Tempat Lahir" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tanggal Lahir</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xtgl_lahir" value="<?php echo $tgl_lahir;?>" class="form-control" id="inputUserName" autocomplete="off" placeholder="Contoh: 25 September 1993" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Mata Pelajaran</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xmapel" value="<?php echo $mapel;?>" class="form-control" id="inputUserName" autocomplete="off" placeholder="Contoh: PPKN, Matematika" required>
                                        </div>
                                    </div>
